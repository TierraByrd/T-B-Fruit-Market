  ...
  return (
    <div className="container">
      <div>
        ...
        <p>Welcome to Fruit Market, the premier destination for buying and selling fresh and high-quality fruits. Whether you're a fruit enthusiast or a seller, we provide a seamless platform to connect with others and enjoy a variety of delicious fruits.</p>
        <h3>Our Mission</h3>
